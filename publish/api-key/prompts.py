...
1. Use the web_search tool to gather 8-15 high-quality, current sources on the topic (research thoroughly).
...
- If no suitable image is found, generate a custom feature image as an SVG with:
