...
|---|---|---|---|
| `display: table-cell` | ✅ | ✅ | ❌ कधीही नाही |
| Negative margins | ✅ | ✅ | ❌ कधीही नाही |
| `abs` + `translate(-50%, -50%)` | ✅ | ✅ | ⚠️ टाळा |
| `inset: 0` + `margin: auto` | ✅ | ✅ | ⚠️ कधी कधी |
| `margin: auto` | ✅ | ❌ | ✅ केवळ क्षैतिज |
| Flexbox | ✅ | ✅ | ✅ चांगला डिफॉल्ट |
| CSS Grid | ✅ | ✅ | ✅ सर्वोत्तम डिफॉल्ट |
